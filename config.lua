...
Config.Zones = {
	...
	BlackWeashop = {
		...
		Locations = {
			...
			vector3(342.29, -1211.05, 29.8),
			vector3(174.34, -1830.01, 27.12)
		},
		SellerPed = {
			{pedtype = 17, model = "csb_hao", x = 176.13, y = -1828.03, z = 28.13, heading = 150.64}
		},
		Vehicles = {
			{model = "burrito", x = 176.94, y = -1832.77, z = 28.11, heading = 133.26}
		}
	}
